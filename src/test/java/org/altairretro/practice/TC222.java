...
public class TC222 {
	public static void main(String[] args) throws InterruptedException {
		...
		String addo = excel.getDataFromExcel(IConstants.EXCEL, "Sheet3", 1, 2);
		String custo = excel.getDataFromExcel(IConstants.EXCEL, "Sheet3", 2, 2);
		...
		web.selectDropdown(customer, custo);
		//Thread.sleep(2000);
...
for(int i=1;i<c;i++)
{
	...
	{
		if(r.getText().equalsIgnoreCase(custo))
		{
...
//div[@id='headset']//div[@class='col-sm-4 col-md-2']//input[@name='addpos']

		//input[@type='text'])[4]

//div[@id='headset']//div[@class='col-sm-4 col-md-2']//h6[text()='Rpee15']/following-sibling::input[@name='quantity']

//div[@id='headset']//div[@class='col-sm-4 col-md-2']//h6[text()='Rpee15']/following-sibling::input[@name='quantity']/following-sibling::input[@value='Add']
